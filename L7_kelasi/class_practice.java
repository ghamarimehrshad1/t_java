...
public class Tak {
    ...
    public static void main(String[] args) {
        ...
        try{
            UserServ.getInstance().save(new UserEnti(). setId(1).setName("mehrshad").setEmail("mehrshad@gmail.com").setUsername("mgh").setPassword("1234"));
        }catch (Exception e){
            System.out.println("fail to save..."+e.getMessage());
        }

        try {
            if (uName.equals("mgh") && pWord.equals("1234")) {
