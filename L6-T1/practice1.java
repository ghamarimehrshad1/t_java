        ...
        try (Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "l6tamrin1",
            ...
            switch (x){
                case 1:
                {
                    ...
                    preparedStatement1.setString(2, "mehrshad");
                    preparedStatement1.setString(3, "ghamari");
                    preparedStatement1.setString(4, "mehrshad@gmail");
                ...
                case 2:
                {
                    ...
                    preparedStatement2.setString(1, "mgh");
                    preparedStatement2.setString(2, "1234");
                    preparedStatement2.setString(3, "mehrshad@gmail.com");
